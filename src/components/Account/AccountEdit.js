...
const AccountEdit = (props) => {
    ...
    const [editUsername, setEditUsername] = useState(props.accountToUpdate.username)
    const [editPassword, setEditPassword] = useState(props.accountToUpdate.password)
                ...
                <ModalBody>
                    <Form onSubmit={accountUpdate}>
                        <FormGroup>
                            ...
                            <Input name="username" value={editUsername} onChange={(e) => setEditUsername(e.target.value)}></Input>
                        </FormGroup>
                        <FormGroup>
                            <Label htmlfor="password">Edit Password:</Label>
                            <Input name="password" value={editPassword} onChange={(e) => setEditPassword(e.target.value)}></Input>
                        </FormGroup>
                        <br/>
