  ...
  return (
    <Container style={{ textAlign: 'center' }}>
      ...
      <Card body outline color='danger' style={{ height: '300px' }}>
        <CardTitle
          style={{ color: 'black', fontWeight: '700', fontSize: '50px' }}
        >
          {typeof account.userAccount != 'undefined' ? (
            'Username' + ' ' + ': ' + account.userAccount[0].username
          ) : (
            <div></div>
          )}
        </CardTitle>
      ...
      {updateActive ? (
        <AccountEdit
          ...
          updateOn={updateOn}
          updateOff={updateOff}
          editUpdateAccount={editUpdateAccount}
